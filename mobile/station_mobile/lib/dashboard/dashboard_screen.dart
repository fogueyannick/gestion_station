      ...
      pw.Page(
        build: (context) => pw.Column(
          ...
          children: [
            ...
            pw.Bullet(text: 'Super1 index : ${r['super1_index']} L → ${venteSuper.toStringAsFixed(0)} FCFA'),
            pw.Bullet(text: 'Super2 index : ${r['super2_index']} L'),
            pw.Bullet(text: 'Super3 index : ${r['super3_index']} L'),
            pw.Bullet(text: 'Gazoil1 index : ${r['gazoil1_index']} L → ${venteGazoil.toStringAsFixed(0)} FCFA'),
...
/*       appBar: AppBar(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final total_autres_ventes = filteredDay.fold<double>(
            0,
          ...
          final total_des_ventes = ventesFcfa + total_autres_ventes;

          final theorique = total_des_ventes - depenses;
              ...
              children: [
                ...
                Card(
                  child: ListTile(
                    ...
                    trailing: Text('${total_des_ventes.toStringAsFixed(0)} FCFA'),
                    onTap: () {
                        ...
                        builder: (ctx) => AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: [
                              ...
                              Text('Total_autres_ventes : ${total_autres_ventes.toStringAsFixed(0)} FCFA'),
                            ],
                          ),
                          actions: [
                ...
                Card(
                  child: ListTile(
                    ...
                    trailing: Text('${total_autres_ventes.toStringAsFixed(0)} FCFA'),
                  ),
                ),
                Card(
